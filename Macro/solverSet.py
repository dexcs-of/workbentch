...
title =  "#!/bin/bash\n"
envSet = ". ~/.FreeCAD/Mod/dexcsCfdOF/Macro/runTreefoamSubset\n"
if TreeFoamVersion.startswith('3') :
    solverSet = os.path.expanduser("~") + "/.FreeCAD/Mod/dexcsCfdOF/Macro/createAndChangeCaseDialogDexcs.py "  + CaseFilePath
else :
