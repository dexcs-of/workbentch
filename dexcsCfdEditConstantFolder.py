...
def makeCfdEditConstantFolder(name="CfdEditConstantFolder"):
...
class _CommandCfdEditConstantFolder:
    ...
    def Activated(self):
        ...
        if not isPresent:
            ...
            FreeCADGui.doCommand("dexcsCfdTools.getActiveAnalysis().addObject(CfdSolverFoam.makeCfdEditConstantFolder())")
