...
class CfdFaceSelectWidget:
    def __init__(self, parent_widget, obj, allow_obj_sel, allow_face_sel, allow_solid_sel,
        ...
        #self.form.objectListWidget.setToolTip(_("Choose solid objects from the list and optionally select one or more of "
    ...
    #     print("deb-buttonAddFaceClicked")
    ...
    #     print("deb-choose_selection_mode_standard")
    #     self.selection_mode_solid = not state
    #     #self.updateSelectionbuttonUI()

    # def choose_selection_mode_solid(self, state):
    #     print("deb-choose_selection_mode_solid")
    ...
    #     print("deb-faceSelectPushButtonChanged")
    #     if checked:
